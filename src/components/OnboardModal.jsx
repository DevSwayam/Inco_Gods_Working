    ...
    switch (st) {
      ...
      case 2:
        return (
          <>
            <p className={styles.modalText}>
              You're on a different network. Switch to Inco Network.
            </p>
      ...
      case 3:
        return (
          <>
            <p className={styles.modalText}>
              Oops, you don't have Inco tokens in your account
            </p>
            <CustomButton
              title="Grab some test tokens"
              handleClick={() => window.open('https://faucetdev.inco.network/', '_blank')}
            />
          </>
        );
